...
namespace CitasEps.Views.AuthUser
{
    public partial class register : Form
    {
        ...
        private readonly EmailConfirmCodeController emailConfirCodeController;
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            if (InputValidator())
            {
                ...
                else
                {
                    ...
                    int newIdUser = usersController.CreateUser(user);
                    ...
                    foreach (string itemName in checkedList.CheckedItems)
                    {
                        ...
                        if (indexSelect != -1)
                        {
                            ...
                            UsersMedia userMedia = new UsersMedia(newIdUser, idMediaSelect);
                            usersMediaController.CreateUsersMedia(userMedia);
                        }
                    }
        ...
        {
            LoginUsersFrm frm = new LoginUsersFrm();
            frm.Show();
            Close();
        }
    }
