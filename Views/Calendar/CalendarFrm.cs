...
namespace CitasEps
{
    public partial class CalendarFrm : Form
    {
        ...
        public CalendarFrm(string officialId, string rol)
        {
            InitializeComponent();
        ...
        public void click_appoinment(object sender, EventArgs e)
        {
            ...
            switch (rol)
            {
                ...
                case ("doctor"):
                    ...
                    break;
                default:
                    new CreateDeleteQuoteFrm(OnCloseQuotesFrm, officialId, quoteId, quoteDateTime).Show();
                    break;
            }
        }
