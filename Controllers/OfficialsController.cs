...
namespace CitasEps.Controllers
{
    class OfficialsController : Controller
    {
        ...
        public List<Official> GetAll()
        {
            ...
            List<Official> data = FormatQueryResult(reader);
            Close();
            return data;
        }
        ...
        public Official GetByAttribute(string attribute, string value)
        {
        ...
        private List<Official> FormatQueryResult(MySqlDataReader readerData)
        {
